...
export const loadUser = () => async dispatch => {
	...
	try {
		const res = await axios.get(`${apiURL}api/demo/auth`);
...
export const updateAccount = (formData, history) => async dispatch => {
	...
	try {
		...
		const res = await axios.post(`${apiURL}api/demo/auth/updateAccount`, formData, config);
...
export const getAccountUpdate = props => async dispatch =>{
	try{
	const res = await axios.get(`${apiURL}api/demo/auth/getAccount`);
...
export const getAllUsers = props => async dispatch =>{
	...
	try{
		const res = await axios.get(`${apiURL}api/demo/users/allusers`);
...
export const getAccountById = (formData) => async dispatch =>{
	...
	const body = JSON.stringify({formData});
	const res = await axios.post(`${apiURL}api/demo/auth/getAccountById`, body, config);
...
export const login = (email, password) => async dispatch => {
	...
	try {
		...
		const res = await axios.post(`${apiURL}api/demo/auth`, body, config);
